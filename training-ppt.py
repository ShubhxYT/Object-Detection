...
# model = YOLO('yolov8n.yaml')  # Choose your model architecture
...
def training_ppt():
    ...
    # Initialize the model
    model = YOLO('yolov8n.yaml')  # You can choose different model architectures like yolov8n.yaml, yolov8m.yaml, etc.
